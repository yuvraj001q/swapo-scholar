    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed max-w-xl mx-auto">Browse hundreds of second-hand JEE, NEET & CBSE books at student-friendly prices.</p>
        </motion.div>
